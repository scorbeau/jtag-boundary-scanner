...
/**
* @file   GpioData.h
* @brief  Define class GpioData model.
* @author Sébastien CORBEAU <sebastien.corbeau@viveris.fr>
*/
#ifndef MODEL_GPIO_DATA_H__
#define MODEL_GPIO_DATA_H__
...
public:
    ...
    bool isGpioUsable(void);

    bool isInputGpio(void);
    bool isOutputGpio(void);
    bool isTristateGpio(void);
